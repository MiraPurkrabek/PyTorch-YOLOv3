...
def create_modules(module_defs):
    ...
    for module_i, module_def in enumerate(module_defs):
        ...
        if module_def["type"] == "convolutional":
            ...
            # Define identification layer
            id_layer = IDLayer()
            modules.add_module("id_{module_i}", id_layer)
...
class IDLayer(nn.Module):
    ...
    Takes vector for each anchor and returns vector for each anchor dividing individuals
    Those three vectors are taken as input to triplet loss 
    """
