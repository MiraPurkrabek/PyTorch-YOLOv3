python3 -W ignore train.py --model_def config/yolov3-custom_human.cfg --data_config config/dataset.data --pretrained_weights weights/yolov3.weights --batch_size=4
