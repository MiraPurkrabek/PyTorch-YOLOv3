...
python3 detect.py --image_folder data/dataset/test2/ --checkpoint_model checkpoints/yolov3_ckpt_sq_150.pth --weights_path checkpoints/yolov3_ckpt_sq_150.pth --model_def config/yolov3-custom.cfg --class_path data/dataset/classes.names
